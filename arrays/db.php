...
$grease_movie_genre = ['Musicale', 'Romantico'];
$terminator_movie_genre = ['Azione', 'Science'];
$himym_tvseries_genre = ["Commedia", "Romantico"];
$simpsons_tvseries_genre = ["Animazione", "Commedia"];
